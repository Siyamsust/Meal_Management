...
- **Mess Management**: Complete mess operations management with manager roles
- **Member Management**: Add, invite, and manage mess members
- **Daily Expense Tracking**: Track and manage daily expenses
- **Meal Tracking**: Record and monitor meal consumption per member
- **Shopping Management**: Track shopping expenses and items
- **Deposit Management**: Handle member deposits and balance tracking
- **Manager Controls**: Change manager, accept/reject member requests
...
- **Dual Dashboard**: Separate interfaces for managers and members
  - **Manager Dashboard**: Full control over mess operations, member management, expense tracking
  - **Member Dashboard**: View personal stats, meal history, and balance
- **Navigation**: React Navigation with stack and tab navigators
- **Authentication**: Secure login/signup with context management and AsyncStorage
- **Mess Operations**:
  - Create new mess
  - Join existing mess
...
- **Async Storage**: Local data persistence for user sessions
- **Real-time Updates**: Socket.io client integration
- **Form Handling**: Phone number input, date/time pickers
- **Role-based Access**: Dynamic UI based on user role (Manager/Member)
